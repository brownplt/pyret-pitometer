requirejs(["pyret-base/js/runtime", "pyret-base/js/exn-stack-parser", "bench/bench-builtin-modules", "program"], function(runtimeLib, stackLib, benchBuiltinModules, program) {
  ...
  // Shared module storage with bench-builtin-modules
  var realm = {};
